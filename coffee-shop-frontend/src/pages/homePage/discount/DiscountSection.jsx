...
export default function DiscountSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#F8F5F0] dark:bg-[#1a1614]">
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-12">
              <div className="text-center sm:text-left space-y-3 mx-auto sm:mx-0 flex-1 flex flex-col items-center">
                <h2 className="text-2xl md:text-3xl font-bold text-amber-900 dark:text-amber-500" style={{ fontFamily: 'serif' }}>
