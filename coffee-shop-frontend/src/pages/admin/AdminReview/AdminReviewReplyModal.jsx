...
export default function AdminReviewReplyModal({ review, onClose, onRefresh }) {
  ...
  return (
    <Dialog open={!!review} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        <div className="bg-white rounded-xl shadow-xl w-full overflow-hidden flex flex-col max-h-[90vh]">
          <DialogHeader>
            <div className="px-6 py-4 border-b flex justify-between items-center bg-gray-50">
              <div className="flex items-center gap-2 text-gray-800">
                <MessageSquareReply className="w-5 h-5" />
                <DialogTitle className="font-semibold text-lg">
                  Phản hồi thẻ đánh giá
                </DialogTitle>
              </div>
              <button
                onClick={onClose}
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute top-0 right-0 bg-red-500 text-white p-0.5 z-10 hover:bg-red-600"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
          ...
          <div className="px-6 py-4 border-t bg-gray-50 flex justify-end gap-3">
            ...
            <Button
              ...
              className="bg-amber-600 hover:bg-amber-700 min-w-28 text-white"
            >
              {isSubmitting ? (
