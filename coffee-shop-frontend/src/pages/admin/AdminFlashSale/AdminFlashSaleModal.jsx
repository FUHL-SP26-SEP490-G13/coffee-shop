    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-2/3 flex flex-col border border-gray-200 rounded-xl overflow-hidden shadow-sm">
            <div className="bg-gray-50 px-4 py-3 border-b flex items-center justify-between">
              <h3 className="font-semibold text-gray-800">Chọn sản phẩm tham gia</h3>
            ...
            <div className="p-4 flex-1 overflow-y-auto bg-white grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-[400px]">
              {products.length === 0 ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">{product.category_name || "Thức uống"}</p>
                      </div>
                    </div>
                  );
                })
