...
export default function AdminFlashSaleModal({
  isOpen,
  onClose,
  saleData,
  onSuccess,
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.productIds.length === 0) {
      return toast.error(
        "Vui lòng chọn ít nhất 1 sản phẩm tham gia Flash Sale!"
      );
    }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent
        ...
        className="sm:max-w-[900px] w-[95vw] max-h-[90vh] overflow-y-auto border-none bg-transparent shadow-none"
      >
        <div className="bg-white dark:bg-gray-900 dark:border-gray-800 w-full rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
          <DialogHeader>
          ...
          <form
            ...
            className="flex-1 overflow-y-auto p-6 flex flex-col md:flex-row gap-8"
          >
            ...
            <div className="w-full md:w-2/3 flex flex-col border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="p-4 flex-1 overflow-y-auto bg-white dark:bg-gray-900 dark:border-gray-800 grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-[400px]">
                {products.length === 0 ? (
                  <p className="text-sm text-gray-500 text-center col-span-2 py-8">
                        ...
                        <div
                          className={`w-5 h-5 rounded flex items-center justify-center border ${
                            isSelected
                              ...
                              : "bg-white dark:bg-gray-900 dark:border-gray-800 border-gray-300"
                          }`}
                        >
                          {isSelected && (
